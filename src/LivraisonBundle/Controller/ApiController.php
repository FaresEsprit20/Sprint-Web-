...
class ApiController extends Controller
{
    ...
    public function editAction(Request $request)
    {
        ...
        $id = $request->get('id');
        $em = $this->getDoctrine()->getManager();
        $taches = $em->getRepository('LivraisonBundle:reclamations')->find($id);
    ...
    public function listAction(Request $request)
    {
        $id = $request->get('id');
        $em = $this->getDoctrine()->getManager();
        $rec = $em->getRepository('LivraisonBundle:reclamations')->findBy(array('agent'=>$id));
        $encoders = array(new XmlEncoder(), new JsonEncoder());
        $normalizer = array(new DateTimeNormalizer(), new ObjectNormalizer());
        $serializer = new Serializer($normalizer, $encoders);
    ...
    public function StatsAction(Request $request)
    {
        ...
        $queryLiv = $repoLivraison->createQueryBuilder('d')
            // Filter by some parameter if you want
            ->andWhere('d.agent = :agent and d.etat = :etats')
        ...
        if ($totalSize > 0) {
          ...
          array('Livr'=>  $percentageliv,'cours'=> $percentageCours, 'total'=> $totalLivraison, 'totalLivrée'=> $queryLiv, 'totalEncours'=> $queryCours),
