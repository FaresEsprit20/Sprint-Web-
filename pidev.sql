...
--
-- Hôte : 127.0.0.1:3306
-- Généré le :  ven. 27 mars 2020 à 04:31
...
CREATE TABLE IF NOT EXISTS `ligne_commande` (
  ...
  PRIMARY KEY (`ref_cmd`,`id_produit`),
  KEY `ref_cmd` (`ref_cmd`),
...
ALTER TABLE `ligne_commande`
  ADD CONSTRAINT `fk_cmd` FOREIGN KEY (`ref_cmd`) REFERENCES `commande` (`ref_cmd`) ON DELETE CASCADE ON UPDATE CASCADE,
